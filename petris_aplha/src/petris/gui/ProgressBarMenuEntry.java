...
public class ProgressBarMenuEntry extends PetrisOptionMenuEntry {
	...
	private int horizDistance = 36; //horizontal distance from parent container borders (best if more than 35)
	
	public ProgressBarMenuEntry(String entryText, Font font, int parentWidth,
	...
	public void paint(Graphics graphics, int y)
	{
		...
		Point titleCoords = GuiUtils.getCenteredChildRectCoords(new Point(0,y), new Dimension(width,height), new Dimension(w, h -5 -barHeight));
		graphics.setFont(textFont);
